  ...
  return (
    <View className="p-4 bg-gray-100 min-h-full">
      ...
      <View className="bg-white rounded-xl shadow-md p-4 space-y-3">
        ...
        <View className="flex-row justify-between">
          <Text className="text-gray-500 font-medium">Pending Fees Amount</Text>
          <Text className="font-semibold text-gray-800">10,000</Text>
        </View>

        <View className="flex-row justify-between">
          <Text className="text-gray-500 font-medium">Pay</Text>
          <Text className="font-semibold text-red-500">Pay</Text>
        </View>
