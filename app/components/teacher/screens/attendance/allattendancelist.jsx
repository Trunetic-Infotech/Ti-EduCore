...
const students = [
  { id: '1', name: 'Asad Shaikh',phone: '9876543210', class: '1', Date: '2023-08-01', status: 'Present' },
  { id: '2', name: 'Pooja Verma',phone: '9876543210', class: '1', Date: '2023-08-01', status: 'Absent' },
  { id: '3', name: 'Rahul Kumar',phone: '9876543210', class: '1', Date: '2023-08-01', status: 'Absent' },
  { id: '4', name: 'Sneha Patil',phone: '9876543210', class: '1', Date: '2023-08-01', status: 'Present' },
  { id: '5', name: 'Anjali Singh',phone: '9876543210', class: '1', Date: '2023-08-01', status: 'Present' },
  { id: '6', name: 'Rohit Sharma',phone: '9876543210', class: '1', Date: '2023-08-01', status: 'Present' },
];
        ...
        return (
          ...
          >
            ...
            <View className="flex-row justify-between items-center mt-3">
              ...
              >
                <Text className="text-white font-semibold text-sm">Mark Present</Text>
              </TouchableOpacity>
              ...
              >
                <Text className="text-white font-semibold text-sm">Mark Absent</Text>
              </TouchableOpacity>
            </View>
          </View>
        );
